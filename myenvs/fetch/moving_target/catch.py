...
from myenvs.fetch import catch_env
...
class Catcher3dEnv(catch_env.CatchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse',
        ...
        catch_env.CatchEnv.__init__(
            self, 'catcher.xml', has_object=False, block_gripper=True, n_substeps=20,
            gripper_extra_height=0.3, target_in_the_air=False, target_offset=0.0,
